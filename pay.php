...
<body>
    ...
    <center>
        ...
        <table border=5 cellspacing="15" borderColor='black'>
            <tr>
                <p>
                    <td colspan=5><img src='img/pay/phonepe.png' alt='phonepe' height=200 width=200></img>
                        <p align="center"><img src="img/pay/PhonePe.svg" height="100px" width="100px"></p>
                        <h3 align="center">&nbsp +91-8500820812</h3>
                        <h5>PhonePe TransactionID starts with 'P'</h5>
                    </td>
                    <td colspan=5><img src='img/pay/gpay.png' alt='tez' height=200 width=200> </img>
                        <p align="center"><img src="img/pay/google-pay.svg" height="100px" width="100px"></p>
                        <h3 align="center">&nbsp +91-8500820812</h3>
                        <h5>For GPay send UPI TransactionID</h5>
                    </td>
                </p>
            </tr>
        </table>
        ...
        <form name="transaction" action='process.php' method='post'>
            <table>
                <tr>
                    <td>
                        <input type='text' name='transactionID' placeholder="Please enter your Transaction ID here: "
                            size="40" required>
                    </td>
                    <td>
